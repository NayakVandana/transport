    ...
    private function seedDrivers(int $userId): array
    {
        $drivers = [
            ...
            'suresh-sharma' => [
                ...
                'salary' => 16500,
                'full_address' => '45, Main Bazaar, Navsari',
                'city' => 'Navsari',
                'taluka' => 'Navsari',
                'district' => 'Navsari',
                'pincode' => '396445',
        ...
        foreach ($drivers as $key => $data) {
            $data['mobiles'] = $data['mobiles'] ?? [];
            $data['mobile'] = $data['mobiles'][0] ?? null;
            $data['address'] = \App\Support\AddressProfileData::buildFormattedAddress($data);
